...
export default function UpdateCollection() {
  ...
  const markAsBounce = async (installment) => {
    ...
    try {
      // First update the installment status
      ...
      // Then create a bounce case
      await api.post('/api/installments/bounce', {
      ...
      alert('Installment marked as bounced and bounce case created!');
      fetchPendingInstallments();
    } catch (error) {
